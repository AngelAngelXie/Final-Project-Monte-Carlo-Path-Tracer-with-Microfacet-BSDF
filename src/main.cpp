...
int main(int argc, char **argv) {
    ...
    Material *light = new Material(
        ...
        (8.0f * Vector3f(0.747f + 0.058f, 0.747f + 0.258f, 0.747f) +
         31.2f * Vector3f(0.740f + 0.287f, 0.740f + 0.160f, 0.740f) +
         36.8f * Vector3f(0.737f + 0.642f, 0.737f + 0.159f, 0.737f)));

    int w = 384, h = 384;
    Vector3f camPos(278, 273, -1600);
    ...
    MeshTriangle light_("../models/light.obj", light, Vector3f(0, 1200, 0));
    ...
    for (int i = 0; i < num_rows; ++i) {
        ...
        auto* soldier_left = new MeshTriangle(soldier_model, white, Vector3f(left_x, 0, z));
        auto* soldier_right = new MeshTriangle(soldier_model, white, Vector3f(right_x, 0, z));
        scene.Add(soldier_left);
        scene.Add(soldier_right);
}
    MeshTriangle king(king_model, white, Vector3f::Zero());
    scene.Add(&king);
